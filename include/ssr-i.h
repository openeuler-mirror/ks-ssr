...
#define SSR_BR_CUSTOM_RA_STRATEGY_FILEPATH SSR_BR_INSTALL_DATADIR "/br-custom-ra-strategy.xml"
#define SSR_BR_CUSTOM_RA_FILEPATH SSR_BR_INSTALL_DATADIR "/br-custom-ra.xml"
...
#define SSR_OFFLINE_INSTALL_PACKAGE_LIST SSR_VULNERABILITY_INSTALL_DATADIR "/offline-install-packages.txt"
    ...
    {
        INSTALLPACKAGEACTION_UNKNOWN = 0,
        INSTALLPACKAGEACTION_DOWNLOAD_PACKAGES,
        INSTALLPACKAGEACTION_DOWNLOAD_METADATA,
        INSTALLPACKAGEACTION_LOADING_CACHE,
        INSTALLPACKAGEACTION_TEST_COMMIT,
        INSTALLPACKAGEACTION_REQUEST,
        INSTALLPACKAGEACTION_REMOVE,
        INSTALLPACKAGEACTION_INSTALL,
        INSTALLPACKAGEACTION_UPDATE,
        INSTALLPACKAGEACTION_CLEANUP,
        INSTALLPACKAGEACTION_OBSOLETE,
        INSTALLPACKAGEACTION_REINSTALL,
        INSTALLPACKAGEACTION_DOWNGRADE,
        INSTALLPACKAGEACTION_QUERY,
