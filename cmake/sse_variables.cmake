...
set(SSE_INSTALL_LIBDIR ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR})
set(SSE_INSTALL_BINDIR ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_BINDIR})
set(SSE_INSTALL_INCLUDE ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_INCLUDEDIR}/${PROJECT_NAME})
set(SSE_INSTALL_DATADIR ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME})
set(SSE_INSTALL_SYSCONFDIR /${CMAKE_INSTALL_SYSCONFDIR}/${PROJECT_NAME})
set(SSE_PLUGIN_ROOT_DIR ${SSE_INSTALL_LIBDIR}/${PROJECT_NAME}/plugins)
...
list(APPEND SSE_COMPILER_FLAGS
...
list(APPEND SSE_COMPILER_FLAGS    # for C++
  #-fno-rtti                       # Disable real-time type information
  -Wsign-compare                  # Warn about mixed signed/unsigned type comparisons
  )

if(COMPILER_GCC AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 8.0)
  list(APPEND SSE_COMPILER_FLAGS -Wno-format-truncation) # deal with a bug in gcc8
endif()


list(APPEND SSE_COMPILER_FLAGS_DEBUG
  -O0                             # Disable optimizations
  -g                              # Generate debug information
  )

list(APPEND SSE_COMPILER_FLAGS_RELEASE
...
list(APPEND SSE_LINKER_FLAGS_RELEASE
