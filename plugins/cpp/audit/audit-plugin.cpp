/**
 * @file          /kiran-sse-manager/plugins/cpp/audit/audit-plugin.cpp
 * @brief         
...
namespace Kiran
{
PLUGIN_EXPORT_FUNC_DEF(SSEPluginAudit);

void SSEPluginAudit::activate()
{
}

void SSEPluginAudit::deactivate()
{
}

std::string SSEPluginAudit::execute(const std::string& in_json)
{
