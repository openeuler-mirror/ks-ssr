...
def is_cent_os_6():
    return len(br.utils.subprocess_has_output("cat /etc/redhat-release | grep -E '\s6\.'")) > 0

def is_cent_os_7():
    return len(br.utils.subprocess_has_output("cat /etc/redhat-release | grep -E '\s7\.'")) > 0