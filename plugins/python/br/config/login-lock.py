...
class LoginLock:
    def __init__(self):
        self.system_faillock_preauth = br.configuration.PAM(LOGIN_LOCK_SYSTEM_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_PREAUTH_REGEX)
        self.system_faillock_authfail = br.configuration.PAM(LOGIN_LOCK_SYSTEM_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_AUTHFAIL_REGEX)
        self.system_faillock_authsucc = br.configuration.PAM(LOGIN_LOCK_SYSTEM_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_AUTHSUCC_REGEX)
        self.system_faillock_account = br.configuration.PAM(LOGIN_LOCK_SYSTEM_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_REGEX)

        self.password_faillock_preauth = br.configuration.PAM(LOGIN_LOCK_PASSWORD_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_PREAUTH_REGEX)
        self.password_faillock_authfail = br.configuration.PAM(LOGIN_LOCK_PASSWORD_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_AUTHFAIL_REGEX)
        self.password_faillock_authsucc = br.configuration.PAM(LOGIN_LOCK_PASSWORD_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_AUTHSUCC_REGEX)
        self.password_faillock_account = br.configuration.PAM(LOGIN_LOCK_PASSWORD_CONF_PATH, LOGIN_LOCK_CONF_KEY_FAILLOCK_REGEX)

        self.lightdm_tally2 = br.configuration.PAM(LIGHTDM_CONF_PATH, LIGHTDM_CONF_REGEX)
