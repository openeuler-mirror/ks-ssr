...
class PasswordExpired:
    ...
    def get(self):
        retdata = dict()
        retdata[PASSWORD_EXPIRED_CONF_KEY_MAX_DAYS] = int(
    ...
    def set(self, args_json):
        ...
        self.conf.set_value(PASSWORD_EXPIRED_CONF_KEY_MAX_DAYS,
                            args[PASSWORD_EXPIRED_CONF_KEY_MAX_DAYS])
        self.conf.set_value(PASSWORD_EXPIRED_CONF_KEY_MIN_DAYS,
                            args[PASSWORD_EXPIRED_CONF_KEY_MIN_DAYS])
        # self.conf.set_value(PASSWORD_EXPIRED_CONF_KEY_MIN_LEN, args[PASSWORD_EXPIRED_CONF_KEY_MIN_LEN])
        self.conf.set_value(PASSWORD_EXPIRED_CONF_KEY_WARN_AGE,
                            args[PASSWORD_EXPIRED_CONF_KEY_WARN_AGE])

        # +86399s，表示到当天的23:59:59过期
        set_expiration_time = 'date -d @{0} "+%Y-%m-%d"'.format(
            args[PASSWORD_EXPIRED_ACCOUNTS_KEY] * 86400 + int(self.curtime) + 86399)
        ...
        for pwdent in pwd.getpwall():
            if THREE_RIGHTS_USERS.__contains__(pwdent.pw_name):
                ...
                if args[PASSWORD_EXPIRED_ACCOUNTS_EXPIRATION_KEY] == True:
                    ...
                    cmd_sums = cmd_sums + set_acc_expired_cmd + ";"
                    # ssr.utils.subprocess_not_output(set_acc_expired_cmd)
        ssr.utils.subprocess_not_output(cmd_sums)
...
class PasswordComplexity:
    def __init__(self):
        self.system_conf = ssr.configuration.PAM(
    ...
    def set(self, args_json):
        ...
        if len(self.system_conf.get_line()) == 0:
            self.system_conf.set_line(
                PASSWORD_COMPLEXTIY_CONF_KEY_PWQUALITY, PASSWORD_COMPLEXITY_CONF_NEXT_MATCH_LINE_PATTERN)

        self.system_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_MINLEN, '=', args[PASSWORD_COMPLEXITY_CONF_KEY_MINLEN], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_CAPITAL,
                                   '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_CAPITAL], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_MINUSCULES,
                                   '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_MINUSCULES], '=')
        self.system_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_NUMBER, '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_NUMBER], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_SPECIAL,
                                   '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_SPECIAL], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_MINCLASS,
                                   '=', args[PASSWORD_COMPLEXITY_CONF_KEY_MINCLASS], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_SUCCESSION,
                                   '=', args[PASSWORD_COMPLEXITY_CONF_KEY_SUCCESSION], '=')
        self.system_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_USER_CHECK, '=',
        ...
        self.password_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_MINLEN, '=', args[PASSWORD_COMPLEXITY_CONF_KEY_MINLEN], '=')
        self.password_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_CAPITAL, '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_CAPITAL], '=')
        self.password_conf.set_value(PASSWORD_COMPLEXITY_CONF_KEY_MINUSCULES,
                                     '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_MINUSCULES], '=')
        self.password_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_NUMBER, '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_NUMBER], '=')
        self.password_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_SPECIAL, '=', -args[PASSWORD_COMPLEXITY_CONF_KEY_SPECIAL], '=')
        self.password_conf.set_value(
            PASSWORD_COMPLEXITY_CONF_KEY_MINCLASS, '=', args[PASSWORD_COMPLEXITY_CONF_KEY_MINCLASS], '=')
        self.password_conf.set_value(
