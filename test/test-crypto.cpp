/**
 * @file          /ks-ssr-manager/test/test-crypto.cpp
 * @brief         
...
TEST(RSATest, EncryptAndDecrypt)
{
    ...
    auto encrypted_text = KS::CryptoHelper::rsa_encrypt(private_filename, raw_text);
    auto decrypted_text = KS::CryptoHelper::rsa_decrypt(public_filename, encrypted_text);
...
TEST(DESTest, EncryptAndDecrypt)
{
    ...
    auto encrypted_text = KS::CryptoHelper::des_encrypt(raw_text);
    auto decrypted_text = KS::CryptoHelper::des_decrypt(encrypted_text);
