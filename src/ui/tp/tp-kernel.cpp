                                      ...
                                      m_refreshTimer(nullptr)
{
    ...
    connect(m_refreshTimer, &QTimer::timeout, this, &TPKernel::refreshTimerTimeout);
...
void TPKernel::refreshClicked(bool checked)
{
    m_refreshTimer->start(100);
    updateInfo();
}

void TPKernel::recertificationClicked(bool checked)
{
...
void TPKernel::refreshTimerTimeout()
{
    static int count = 0;
    count++;
