...
void User::showPasswordModification()
{
    ...
    if (!m_passwordModification)
    {
        ...
        connect(m_passwordModification, &PasswordModification::accepted, this, &User::acceptedPasswordModification);
    }
...
void User::setLoginUserName(const QString &userName)
{
    m_login->setAccountName(userName);
}

QString User::getCurrentUserName() const
{
      ...
      m_passwordModification(nullptr)
{
    ...
    connect(m_dbusProxy, &AccountProxy::PasswordChanged, this, &User::passwordChanged);
}
...
void User::acceptedPasswordModification()
{
