...
#include "device-record-delegate.h"
#include <QPainter>
...
DeviceRecordDelegate::DeviceRecordDelegate(QObject *parent) : QStyledItemDelegate(parent)
{
}

DeviceRecordDelegate::~DeviceRecordDelegate()
{
}

void DeviceRecordDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    painter->save();
