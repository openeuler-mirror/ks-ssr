...
void BaselineReinforcement::initConnection()
{
    ...
    connect(m_ui->m_fallbackInit, &QPushButton::clicked, this, [this] { fallback(BRFallbackMethod::BR_FALLBACK_METHOD_INITIAL); });
    connect(m_ui->m_fallbackPrevious, &QPushButton::clicked, this, [this] { fallback(BRFallbackMethod::BR_FALLBACK_METHOD_LAST); });
