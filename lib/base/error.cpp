...
QString Error::getErrorDesc(SSRErrorCode errorCode)
{
    ...
    case ERROR_PLUGIN_BR_SET_STANDARD_TYPE_FAILED:
    case ERROR_PLUGIN_BR_SET_STRATEGY_TYPE_FAILED:
    case ERROR_PLUGIN_BR_SET_TIME_SCAN_FAILED:
    case ERROR_PLUGIN_BR_SET_NOTIFICATION_STATUS_FAILED:
    case ERROR_PLUGIN_CONFIG_JSON_EXCEPTION:
    case ERROR_PLUGIN_CONFIG_REINFORCEMENT_NOTFOUND:
    case ERROR_PLUGIN_BR_SET_REINFORCEMENT_FAILED:
    case ERROR_PLUGIN_AUDIT_GET_JSON_ERROR:
    case ERROR_PLUGIN_AUDIT_SET_JSON_ERROR:
    case ERROR_PLUGIN_BR_GEN_REINFORCEMENT_FAILED:
